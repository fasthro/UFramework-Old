...
namespace FastEngine.Core
{
    ...
    /// </summary>
    [MonoSingletonPath("FastEngine/EasyTouch")]
    public class EasyTouch : MonoSingleton<EasyTouch>
    {
        ...
        public static void SetEnabled(bool enable)
        {
            ...
            if (enable && Instance.mainCam == null)
                Debug.LogError("Please set easy touch camera!");
        }
