...
namespace FastEngine.Utils
{
    public static class ZipUtils
    {
        ...
        /// <returns></returns>
        public static bool Zip(string[] fileArray, string[] parentbArray, string _outputPathName, string _password = null, ZipCallback _zipCallback = null)
        {
